...
- **Per-app `vercel.json`** under `apps/pk-store`, `apps/dashboard`, and `apps/admin` — install from repo root when Vercel Root Directory is that app folder.

## Frontend App Standard (`apps/pk-store/src`)
