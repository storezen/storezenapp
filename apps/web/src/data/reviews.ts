...
export const reviews: Review[] = [
  ...
  },
  {
    ...
    city: 'Multan',
    rating: 5,
    review_text: 'Ordered XL size, fits perfectly. The band design is amazing, exactly like the product photo. My friends loved it. SmartWear is my go-to store now!',
    date: '3 weeks ago',
    verified_purchase: true,
    helpful: 9,
  },
  ...
  },
  {
    ...
    city: 'Lahore',
    rating: 5,
    review_text: 'Third time ordering this perfume — that says it all. Best value perfume available online in Pakistan. SmartWear always delivers on time and the quality is consistent.',
    date: '1 month ago',
    verified_purchase: true,
    helpful: 28,
  },
